# guides
Houses the user guide, information about the mechanics and how to use them. 
...
Then you can just use the [CLI](https://rust-lang.github.io/mdBook/cli/index.html) namely the ``build`` and ``serve`` commands.
